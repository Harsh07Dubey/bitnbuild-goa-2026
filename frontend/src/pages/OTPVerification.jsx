...
function PhaseStepper({ currentPhase = 2 }) {
  return (
...
export default function OTPVerification() {
  ...
  }, [currentCode, phone, verifyOtp, navigate]);
      ...
      >
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-7">
            ...
            {/* Demo OTP Hint */}
            <div className="mb-5 flex items-center justify-between p-3 rounded-xl bg-blue-50 border border-blue-100">
              <div className="flex items-center gap-2 text-xs text-blue-700">
                <Info className="w-3.5 h-3.5 text-blue-500 shrink-0" />
                <span>
                  Demo code:{' '}
                  <span className="font-mono font-bold tracking-widest">{DEMO_OTP_CODE}</span>{' '}
                  (or any 6 digits)
                </span>
              </div>
              <button
                ...
                className="text-[11px] font-bold text-[#2563EB] bg-white border border-blue-200 px-2.5 py-1 rounded-lg hover:bg-blue-50 transition-colors whitespace-nowrap"
              >
                Auto-fill →
              </button>
            </div>
            ...
            <div className="flex gap-2 sm:gap-3 justify-center mb-5" onPaste={handlePaste}>
              {digits.map((digit, idx) => (
                <motion.input
                  ...
                  transition={{ duration: 0.3 }}
                  className={`w-11 h-14 sm:w-12 sm:h-14 text-center text-xl font-black font-mono rounded-xl border-2 focus:outline-none transition-all ${
                    verified
            ...
            <AnimatePresence>
              {verified && (
                ...
                >
                  ...
                  <span>Verified! Redirecting to profile setup...</span>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <div className="mt-4 text-center text-xs text-slate-500">
              {resendSeconds > 0 ? (
                ...
                <button
                  ...
                  className="text-[#2563EB] font-bold hover:underline flex items-center gap-1.5 mx-auto transition-colors"
                >
                  {resendLoading ? (
